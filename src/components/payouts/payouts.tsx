  ...
  return (
    <section className={`${s.payouts} container`}>
      <article>
        ...
        <p>
          Our organization, being a Decentralized Autonomous Organization (DAO),
          enables auditing through direct examination of the DAO and the open
          ledger on the blockchain.
          <br />
          <br />
          This transparent framework ensures operational integrity, as funds
          cannot be transferred without a consensus vote. The only exception is
          the smart contract for passive income, which is programmed to activate
          monthly based on pre-established code, maintaining the transparency
      ...
      <div className={s["payouts-cards"]}>
        ...
        <div className={s["payouts-card"]}>
          ...
          <p>
            ...
            <br /> artificial intelligence, TrustBet On-Chain
            <br /> revolutionizes transaction processes, avoiding the
            <br /> need for traditional trust mechanisms. This model
            <br /> guarantees fairness and facilitates immediate
            <br /> payouts, showcasing the transformative benefits
            <br /> and capabilities of these cutting-edge
            <br /> technologies.
          </p>
