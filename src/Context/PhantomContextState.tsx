  ...
  const Connect = async (
    ...
    if (walletType === "Phantom") {
      if (!("phantom" in window)) {
        return window.open(
          ...
          "https://phantom.app/ul/browse/https://landing-git-feature-uinewchanges-trust-bet.vercel.app/?ref=https://landing-git-feature-uinewchanges-trust-bet.vercel.app/",
          "_blank",
        );
      }
    }
    if (walletType === "Solflare") {
      if (!("solflare" in window)) {
        return window.open(
          `https://solflare.com/ul/v1/browse/${encodeURIComponent("https://landing-git-feature-uinewchanges-trust-bet.vercel.app")}/?ref=https://landing-git-feature-uinewchanges-trust-bet.vercel.app/`,
        );
      }
    }
    try {
