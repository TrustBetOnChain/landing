      ...
      <ul className={`${s["benefits-cards"]} container`}>
        ...
        <li className={s["benefits-card"]}>
          ...
          <p>
            ...
            Early investment not only guarantees your place ahead of the general
            public but also provides a significant advantage when the platform
            is listed on our first and subsequent Tier 1 exchanges.
          </p>
        </li>
      </ul>
