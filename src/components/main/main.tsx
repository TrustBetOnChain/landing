...
export const Main = () => {
    return (
        <section className={s["main-section"]}>
            ...
            <h3 className={s["h3"]}>Start earning and receive daily passive staking income from a licensed and regulated global casino and betting platform no matter the market conditions.</h3>
