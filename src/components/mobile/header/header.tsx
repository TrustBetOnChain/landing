        ...
        <div className={s["pop-up"]}>
            ...
            <aside className={s["aside"]}>
                ...
                <ul className={s["aside-list"]}>
                    <li>
                    <a onClick={() => setModal(false)} src={Cross} href={`#${PageSection.ABOUT}`}>About</a>
                    </li>
                    <li>
                    <a onClick={() => setModal(false)} src={Cross} href={`#${PageSection.HOW_TO_START}`}>How to start</a>
                    </li>
                    <li>
                    <a onClick={() => setModal(false)} src={Cross} href={`#${PageSection.TBET_TOKENS}`}>TBET tokens</a>
                    </li>
                    <li>
                    <a onClick={() => setModal(false)} src={Cross} href={`#${PageSection.ROADMAP}`}>Roadmap</a>
                    </li>
                    <li>
                    <a onClick={() => setModal(false)} src={Cross} href={`#${PageSection.CONTACT}`}> Contact</a>
                    </li>
                </ul>
